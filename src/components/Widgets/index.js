    ...
    <div className={styles.widgets_container}>
      <div className={styles.recommend_widgets}>
        ...
        <div className={styles.recommend_item}>
          <img
            className={styles.icon}
            src="https://styles.redditmedia.com/t5_3h7yi/styles/communityIcon_9ds9kugm99g51.png?width=256&s=3ee4c30d4736dc4024319d53c20c6dacb5d11bb0"
            alt="javascript icon"
          />
          <div>
            <h4>#Next.js</h4>
        ...
        <button className={styles.btn_viewMore}>
